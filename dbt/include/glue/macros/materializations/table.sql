{% materialization table, adapter = 'glue', supported_languages=['sql']%}
  ...
  {% if existing_relation is not none %}
    ...
    {% set is_iceberg = ((adapter.is_iceberg_relation(existing_relation) or existing_relation.is_iceberg) and config.get('file_format', validator=validation.any[basestring]) == 'iceberg') %}
  {% else %}
    {% set is_delta = false %}
